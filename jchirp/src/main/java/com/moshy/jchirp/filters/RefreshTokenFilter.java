...
public class RefreshTokenFilter extends OncePerRequestFilter {
    ...
    public RefreshTokenFilter(@Qualifier("LookupByRefresh") UserDetailsService userDetailsService) {
        ...
        if (token != null) {
            if (SecurityContextHolder.getContext().getAuthentication() == null) {
                ThrowableToOptional.orEmpty(
                    () -> userDetailsService.loadUserByUsername(token), UsernameNotFoundException.class
                ).ifPresent(details -> {
